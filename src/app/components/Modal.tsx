...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 bg-black dark:bg-opacity-50 bg-opacity-20 backdrop-blur-md flex justify-center items-center">
      <div
        ref={ref}
        className="dark:bg-zinc-800 bg-white shadow-lg dark:bg-opacity-80 bg-opacity-70 dark:text-white px-8 pt-14 pb-4 md:rounded-lg relative md:w-[45rem] md:h-[40rem] w-full h-full rounded-none overflow-y-auto"
      >
        <X
